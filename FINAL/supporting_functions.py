...
#READ THIS FOR UNDERSTANDING THE PURPOSE OF THE FUNCTION
#Have a look at supporting_functions.py to see what these functions are doing. In update_rover() your RoverState() object gets updated with each new batch of telemetry. 
...
#READ THIS FOR UNDERSTANDING THE PURPOSE OF THE FUNCTION
#The create_output_images() function is where your Rover.worldmap is compared with the ground truth map and gets converted, along with Rover.vision_image, into base64 strings to send back to the rover. 
